...
parser.add_argument('-vid','--video', default="Input/2.mp4",help="Video File Path")
parser.add_argument('-roi','--roi creation mode',default="manually",help="Create region of interest-do it 'manually'," + 
